...
serving Boston, Massachusetts, as the legal forum for any such dispute.
          ...
          <b>Introduction</b>
          <p>
            The Humans: A Recording of Our Voices Project (the “Project”) is committed to supporting the privacy of
those who seek to participate in the Project. This Privacy Statement explains how we handle and use
the personal information we collect as part of the submission process.  
          </p>
          <b>What personal information we collect </b>
          <p>
          <li>While specific information may vary for particular individuals, we may collect, use, store and transfer
different kinds of personal information about you, which we have grouped together as follows: 
          </li><li>Basic biographic/contact information – name, email addresses, and social media contact
information
          ...
          <p>
          <b>How we collect personal information about you </b>
          </p><p>The only personal information we collect is that which you provide voluntarily for inclusion in the
Project.  
          </p>
          <b>How we use your personal information</b>
          <p>We use your personal information for a number of legitimate purposes all in support of the Institute and
its mission. Here, we use your personal information for purposes of the Project only.  
          </p>
          <p>If you have concerns about any of these purposes, or how we communicate with you, please contact us
at <a target="_blank" href="mailto:humans_info@mit.edu">humans_info@mit.edu</a>. We will always respect a request by you to stop processing your personal
information (subject to our legal obligations).
          </p>
          <b>When we share your personal information</b>
          <p>We do not share your personal information with any third parties.  
          </p>
          <b>How your information is stored and secured</b>
          <p>Your textual message is stored on MongoDB, for more information about their security and privacy
policy, please visit this <a target="_blank" href="https://www.mongodb.com/legal/privacy-policy">link</a>.
          </p>
          <p>Your audio message is stored on AWS, for more information about their security and privacy policy,
please visit this <a target="_blank" href="https://aws.amazon.com/privacy/">link</a>.</p>
          
          <b>How long we keep your personal information</b>
          <p>We keep your personal information for MIT’s historical and archival purposes and the defense of legal
claims. For the text and audio submission, we keep them in perpetuity for the purposes of the project.
          </p>

          <b>Rights for Individuals in the European Economic Area</b>
          <p>You have the right in certain circumstances to (1) access your personal information; (2) to correct or
...
regional data protection authority.  
          ...
          If you are inclined to exercise these rights, we request an opportunity to discuss with you any concerns
you may have. To protect the personal information we hold, we may also request further information to
verify your identity when exercising these rights. Upon a request to erase information, we will maintain
a core set of personal data to ensure we do not contact you inadvertently in the future, as well as any
information necessary for MIT archival purposes. We may also need to retain some financial
information for legal purposes, including US IRS compliance. In the event of an actual or threatened
legal claim, we may retain your information for purposes of establishing, defending against or exercising
our rights with respect to such claim.
          </p><p>
          By providing information directly to MIT, you consent to the transfer of your personal information
...
laws and regulations of the EEA.
          ...
          <p>We may change this Privacy Statement from time to time.  If we make any significant changes in the way
we treat your personal information we will make this clear on our MIT websites or by contacting you
directly. 
          </p>
          
          <br></br><p><b><i>This policy was last updated in April 2021.</i></b></p>
